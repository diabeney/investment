...
export default function MarketInsights() {
  return (
    <div className="py-16 p-4  lg:p-10">
      <h1 className=" text-center mb-4 text-5xl lg:text-6xl font-semibold">
      ...
      <div className=" max-w-screen-lg mx-auto ">
        <section className=" flex flex-col gap-2 md:px-6">
          <Link
            href={"/"}
            className=" text-2xl hover:bg-stone-50 font-semibold border-b py-4 flex items-center justify-between border-b-black"
          >
