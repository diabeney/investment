  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="-mt-3">
          We invite you to explore what's possible with BlackCrest. Schedule a
          consultation to learn how our personalized investment strategies can
      ...
      <div>
        <p className={"text-sm text-black"}>
          You can send us a direct email{" "}
          <a href="mailto:info@bc-capital.org" className={"underline"}>
            here
          </a>
        </p>
      </div>
